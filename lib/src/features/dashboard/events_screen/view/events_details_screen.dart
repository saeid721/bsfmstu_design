...
import '../model/events_details_model.dart';
import 'components/events_details_widget.dart';
      ...
      body: GlobalContainer(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              EventsDetailsWidget(
                title: eventsDetailsModel.title,
                imagePath: eventsDetailsModel.imagePath,
                details: eventsDetailsModel.details,
                startDate: eventsDetailsModel.startDate,
                endDate: eventsDetailsModel.endDate,
              ),
            ],
          ),
        ),
