...
import 'components/department_sub_category_details_widget.dart';

class DepartmentDetailsMenuScreen extends StatefulWidget {
  const DepartmentDetailsMenuScreen({super.key});

  @override
  State<DepartmentDetailsMenuScreen> createState() => _DepartmentDetailsMenuScreenState();
}

class _DepartmentDetailsMenuScreenState extends State<DepartmentDetailsMenuScreen> with SingleTickerProviderStateMixin {
                    ...
                    Center(
                      child: ListView.builder(
                        ...
                        itemBuilder: (ctx, index) {
                          return DepartmentSubCategoryDetailsWidget(
