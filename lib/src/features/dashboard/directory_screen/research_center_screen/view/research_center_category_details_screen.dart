...
import 'components/research_center_category_details_widget.dart';

class ResearchCenterDetailsMenuScreen extends StatefulWidget {
  const ResearchCenterDetailsMenuScreen({super.key});

  @override
  State<ResearchCenterDetailsMenuScreen> createState() => _ResearchCenterDetailsMenuScreenState();
}

class _ResearchCenterDetailsMenuScreenState extends State<ResearchCenterDetailsMenuScreen> with SingleTickerProviderStateMixin {
                    ...
                    Center(
                      child: ListView.builder(
                        ...
                        itemBuilder: (ctx, index) {
                          return ResearchCenterDetailsMenuWidget(
