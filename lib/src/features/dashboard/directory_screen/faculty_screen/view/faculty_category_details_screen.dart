...
import 'components/faculty_category_details_widget.dart';
...
class _FacultyDetailsScreenState extends State<FacultyDetailsScreen> with SingleTickerProviderStateMixin {
                    ...
                    Center(
                      child: ListView.builder(
                        ...
                        itemBuilder: (ctx, index) {
                          return InstituteCategoryDetailsWidget(
