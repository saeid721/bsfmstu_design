...
class ColorRes {
  ...
  /// All Panel Color
  static const Color backgroundColor = Color(0xFFF9F5AE);
  static const Color primaryColor = Color(0xFF0f3375);
  static const Color secondaryColor = Color(0xFF002147);
  static const Color borderColor = Color(0xffE5E4E2);
  static const Color yellow = Color(0xFFFFFF00);
  static const Color red = Color(0xFFEE1C25);
